...
// code:
const name = "ytk";
const fullName = "YTK Stable Coin"; //It is recommended that the wallet and browser display the name of the currency as "name(fullName)", for example: ytk(YTK stable coin)
const decimal = 8;
