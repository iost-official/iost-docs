...
Every new account need a minimum gas pledgement of 10 IOST, and `signUp` method will do this pledgement automatically for the new account.
**So creating a new account needs 10 IOSTs and 0 byte RAM**.
