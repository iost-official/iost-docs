...
|headBlock.txs|ブロック内のトランザクションですが、今は空
...
Base58エンコードされたトランザクションのハッシュによりトランザクションのレシートデを取得します。
### パラメータ  

| キー |値 |
|--|--|
|hash|Base58エンコードされたトランザクションのハッシュ
### レスポンス 
| キー |値 |
|--|--|
