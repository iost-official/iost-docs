...
После исполнения смарт-контракт будет генерировать `TxReceipt` в блок и стремиться к консенсусу. Вы можете использовать RPC для отслеживания TxReceipts из транзакций в цепи.
