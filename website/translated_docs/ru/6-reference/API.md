...
tx\_merkle\_hash    |string |дерево хешей всех транзакций
tx\_receipt\_merkle\_hash   |string |дерево хешей всех квитанций
...
### PledgeInfo (Информация о залоге)

Ключ                 |Тип       |Описание
----                    |--         |--
pledger         |string     |аккаунт, вносящий депозит(залог)
amount          |double |сумма депозита(залога)
