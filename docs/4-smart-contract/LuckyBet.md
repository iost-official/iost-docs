...
You should [launch a local server](3-running-iost-node/LocalServer.md) firstly.   

## Step2: Install iWallet
You should follow [this documentation](3-running-iost-node/Building-IOST.md) to build IOST then.
